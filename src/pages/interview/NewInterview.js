...
import { fetchDataAction, fetchQuestionsDataAction, fetchQuestionsNumDataAction, defaultQuestionsNum, stepResetAction, stepsResetAnswersAction } from '../../Actions';
...
export default function NewInterview() {
  const defaultValueArray = defaultQuestionsNum();
