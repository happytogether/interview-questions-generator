...
export default function Memphis16_4(props) {
  ...
  return (
    <div className="z-10" style={styles}>
      <svg viewBox="0 0 950 572" version="1.1" xmlns="http://www.w3.org/2000/svg">
          <title>Group 2</title>
          <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
              <g id="Group" transform="translate(-99.940000, 0.000000)" fillRule="nonzero">
                  <g id="Group-2" transform="translate(100.519000, 0.000000)">
