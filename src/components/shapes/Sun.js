...
export default function Sun(props) {
  ...
  const colorSet = getRandomFromArray(BasicColorSet.filter((item) => {
    return item!==props.noShowColor;
  }));
              ...
              <g transform="translate(-3116.000000, -361.000000)">
                  <g transform="translate(59.595000, 292.547000)">
                      <g transform="translate(3057.155000, 68.653000)">
                          <path d="M147.3,0 C187.97,0 224.79,16.487 251.44,43.148 C278.1,69.794 294.59,106.63 294.59,147.298 L0,147.298 C0,65.947 65.95,0 147.3,0" fill={`var(--${colorSet[0]})`}></path>
                          <path d="M147.3,147.279 C187.97,147.279 224.79,163.766 251.44,190.426 C278.1,217.073 294.59,253.909 294.59,294.577 L0,294.577 C0,213.226 65.95,147.279 147.3,147.279" fill={`var(--${colorSet[1]})`}></path>
                      </g>
                  </g>
              </g>
          </g>
