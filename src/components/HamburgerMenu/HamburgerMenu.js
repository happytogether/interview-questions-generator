...
export default function HamburgerMenu(props){
  ...
  const bgTextColor = props.bgTextColor;
  ...
  return (
    <Menu styles={ styles }
      ...
      right
    >
      <ul className={`w-full h-full flex flex-row p-8 relative text-base bg-${bgColor}`}>
        <li className="link">
        ...
        <li className="link">
          <DelayLink delay="600" to={{
            pathname: "/interview",
            state: {bgTextColor: [primaryColor, secondaryColor, primaryTextColor, secondaryTextColor, thirdColor, thirdTextColor]}}}>
            <svg className="inline-block mr-4" viewBox="0 0 24 24"><path fill={bgTextColor} d="M8.4,9.464c4.05-1.286,4.693-5.014,4.179-8.357c0,0,0-0.193,0.129-0.129C16.629,2.907,21,6.957,21,13.193 C21,17.821,17.336,22,12,22c-5.786,0-9-4.05-9-8.871c0-2.893,1.929-5.786,4.179-7.071c0,0,0.193,0,0.193,0.129 c0,0.643,0.257,2.25,0.964,3.214L8.4,9.464z"/></svg>
        ...
        <li className="link">
          <DelayLink delay="600" to={{
            pathname: "/report",
            state: {bgTextColor: [primaryColor, secondaryColor, primaryTextColor, secondaryTextColor, thirdColor, thirdTextColor]}}}>
            <svg className="inline-block mr-4" viewBox="0 0 24 24"><path fill={bgTextColor} d="M11.362 2c4.156 0 2.638 6 2.638 6s6-1.65 6 2.457v11.543h-16v-20h7.362zm.827-2h-10.189v24h20v-14.386c0-2.391-6.648-9.614-9.811-9.614zm4.811 13h-10v-1h10v1zm0 2h-10v1h10v-1zm-3 3h-7v1h7v-1z"/></svg>
        ...
        <li className="link">
          <DelayLink delay="600" to={{
            pathname: "/booking",
            state: {bgTextColor: [primaryColor, secondaryColor, primaryTextColor, secondaryTextColor, thirdColor, thirdTextColor]}}}>
            <svg className="inline-block mr-4" viewBox="0 0 24 24"><path fill={bgTextColor} d="M13.5 8c.276 0 .5.224.5.5v7c0 .276-.224.5-.5.5h-11c-.276 0-.5-.224-.5-.5v-7c0-.276.224-.5.5-.5h11zm2.5 0c0-1.104-.896-2-2-2h-12c-1.104 0-2 .896-2 2v8c0 1.104.896 2 2 2h12c1.104 0 2-.896 2-2v-8zm6 1.854v4.293l-2-1.408v-1.478l2-1.407zm2-3.854l-6 4.223v3.554l6 4.223v-12z"/></svg>
